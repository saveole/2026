...
## Purpose
Enable users to quickly post real-time thoughts and notes to GitHub issue comments via a simple command-line interface.
...
- **issue-commenting**: This capability extends the existing issue commenting infrastructure by adding a user-facing CLI tool for manual note posting. It reuses the same GitHubClient, authentication pattern, and metadata approach.
